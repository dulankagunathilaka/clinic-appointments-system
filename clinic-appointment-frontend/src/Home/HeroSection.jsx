      ...
      <div className="container mx-auto px-6 flex flex-col lg:flex-row items-center justify-between">
        ...
        <div className="lg:w-1/2 z-10 space-y-8 text-left py-10 lg:py-0">
          ...
          <p className="text-lg text-gray-600 max-w-lg">
            Elevating your health journey with compassionate care and medical excellence. 
            We provide comprehensive services designed around your well-being, 
            because your health is our greatest commitment.
          </p>
          ...
          {/* Review Card (Separate from Stats Row) */}
          <div className="pt-8">
